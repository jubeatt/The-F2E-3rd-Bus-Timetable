    ...
    <div class="sidebar container__sidebar">
      ...
      <div class="sidebar__pannel">
        ...
        <div v-if="mainBoard" class="main-buttons">
          ...
          <button @click="openMoreBoard" class="button text-color-blue">
            更多
          </button>
        ...
        <form v-if="cityBoard" class="form-city">
          ...
          />
          <label
            :class="{ 'button--selected': selectedCity }"
            class="button button--small-text text-color-blue"
            for="key1"
            >台北市</label
          >
          <input v-model="selectedCity" class="hide" type="radio" id="key2" />
          <label
            :class="{ 'button--selected': selectedCity }"
            class="button button--small-text text-color-blue"
            for="key2"
